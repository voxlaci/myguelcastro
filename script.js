...
const translations = {
  pt: {
    ...
    "hero.eyebrow": "Marido • Pai • Maestro • Professor • Coach • Orador • Júri • Consultor",
    ...
    "hero.whatsappMsg": "Olá, gostaria de contratar Myguel Santos e Castro para um evento.",
    "faq.kicker": "FAQ",
    ...
    "testimonials.q1": '"Convidei o Myguel para uma sessão de abertura de um ciclo de conferências. A energia que trouxe à sala nos primeiros vinte minutos definiu o tom do dia inteiro. O feedback dos participantes foi unânime."',
    "testimonials.q2": '"Fiz o workshop de voz com o Myguel num evento com 60 pessoas. Não acreditava que conseguisse manter toda a gente envolvida numa atividade assim. Acabou a ser o momento mais comentado do dia."',
    "testimonials.q3": '"Participei numa masterclass de direção coral e o nível de atenção individual foi surpreendente. Saí com ferramentas concretas que aplico ainda hoje nos meus próprios ensaios."',
  ...
  en: {
    ...
    "nav.about": "About",
    "nav.contact": "Contact",
    "hero.eyebrow": "Husband • Father • Conductor • Professor • Coach • Speaker • Jury • Consultant",
    ...
    "hero.whatsappMsg": "Hello, I would like to hire Myguel Santos e Castro for an event.",
    "faq.kicker": "FAQ",
    ...
    "testimonials.title": "What those who've worked with Myguel say",
    "testimonials.q1": '"I invited Myguel to open a conference cycle. The energy he brought to the room in the first twenty minutes set the tone for the entire day. The feedback from participants was unanimous."',
    "testimonials.q2": '"I did the voice workshop with Myguel at an event with 60 people. I didn\'t believe he could keep everyone engaged in an activity like that. It ended up being the most talked-about moment of the day."',
    "testimonials.q3": '"I attended a choral conducting masterclass and the level of individual attention was remarkable. I left with concrete tools I still use today in my own rehearsals."',
    "testimonials.role1": "event organiser",
    "testimonials.role2": "participant",
    "testimonials.role3": "choral director",
    ...
    "contact.pr": "Public relations",
    "social.kicker": "Social Media",
    "social.title": "Follow and keep up with Myguel's work",
    "form.name": "Name",
    ...
    "ai.title": "About Myguel Santos e Castro",
    "ai.chip.services": "What services offered?",
    "ai.chip.hire": "How to hire?",
    "ai.chip.international": "International experience?",
    "ai.chip.voxlaci": "What is VoxLaci?",
    "ai.chip.bio": "Who is Myguel?",
  ...
  fr: {
    ...
    "nav.about": "À propos",
    "nav.contact": "Contact",
    "hero.eyebrow": "Mari • Père • Chef de chœur • Professeur • Coach • Orateur • Jury • Consultant",
    ...
    "hero.whatsappMsg": "Bonjour, je souhaite engager Myguel Santos e Castro pour un événement.",
    "faq.kicker": "FAQ",
    ...
    "testimonials.title": "Ce que disent ceux qui ont travaillé avec Myguel",
    "testimonials.q1": '"J\'ai invité Myguel pour une session d\'ouverture d\'un cycle de conférences. L\'énergie qu\'il a apportée en salle dans les vingt premières minutes a donné le ton de toute la journée. Le retour des participants a été unanime."',
    "testimonials.q2": '"J\'ai fait le workshop vocal avec Myguel lors d\'un événement de 60 personnes. Je ne croyais pas qu\'il puisse maintenir tout le monde impliqué dans une activité pareille. Ce fut finalement le moment le plus commenté de la journée."',
    "testimonials.q3": '"J\'ai participé à une masterclass de direction chorale et le niveau d\'attention individuelle était remarquable. J\'en suis sorti avec des outils concrets que j\'applique encore aujourd\'hui dans mes propres répétitions."',
    "testimonials.role1": "organisateur d'événement",
    "testimonials.role2": "participant",
    "testimonials.role3": "directrice chorale",
    ...
    "contact.pr": "Relations publiques",
    "social.kicker": "Réseaux Sociaux",
    "social.title": "Suis et découvres le travail de Myguel",
    "form.name": "Nom",
    ...
    "ai.title": "À propos de Myguel Santos e Castro",
    "ai.chip.services": "Quels services offre-t-il?",
    "ai.chip.hire": "Comment le contacter?",
    "ai.chip.international": "Expérience internationale?",
    "ai.chip.voxlaci": "Qu'est-ce que VoxLaci?",
    "ai.chip.bio": "Qui est Myguel?",
  ...
  it: {
    ...
    "hero.eyebrow": "Marito • Padre • Direttore corale • Professore • Coach • Oratore • Giuria • Consulente",
    ...
    "hero.whatsappMsg": "Ciao, vorrei ingaggiare Myguel Santos e Castro per un evento.",
    "faq.kicker": "FAQ",
    ...
    "testimonials.title": "Cosa dicono coloro che hanno lavorato con Myguel",
    "testimonials.q1": '"Ho invitato Myguel per una sessione di apertura di un ciclo di conferenze. L\'energia che ha portato in sala nei primi venti minuti ha definito il tono dell\'intera giornata. Il feedback dei partecipanti è stato unanime."',
    "testimonials.q2": '"Ho fatto il workshop di voce con Myguel in un evento con 60 persone. Non credevo riuscisse a mantenere tutti coinvolti in un\'attività del genere. È finito per essere il momento più commentato della giornata."',
    "testimonials.q3": '"Ho partecipato a una masterclass di direzione corale e il livello di attenzione individuale è stato sorprendente. Sono uscito con strumenti concreti che applico ancora oggi nelle mie prove."',
    "testimonials.role1": "organizzatore di eventi",
    "testimonials.role2": "partecipante",
    "testimonials.role3": "direttrice corale",
    ...
    "contact.pr": "Relazioni pubbliche",
    "social.kicker": "Social Media",
    "social.title": "Segui e tieniti aggiornato sul lavoro di Myguel",
    "form.name": "Nome",
    ...
    "footer.top": "Torna su",
    "ai.title": "Su Myguel Santos e Castro",
    "ai.chip.services": "Quali servizi offre?",
    "ai.chip.hire": "Come ingaggiarlo?",
    "ai.chip.international": "Esperienza internazionale?",
    "ai.chip.voxlaci": "Cos'è VoxLaci?",
    "ai.chip.bio": "Chi è Myguel?",
  ...
  es: {
    ...
    "nav.about": "Sobre mí",
    "nav.contact": "Contacto",
    "hero.eyebrow": "Esposo • Padre • Director coral • Profesor • Coach • Orador • Jurado • Consultor",
    ...
    "hero.whatsapp": "WhatsApp",
    "hero.secondary": "Ver formatos",
    "hero.whatsappMsg": "Hola, me gustaría contratar a Myguel Santos e Castro para un evento.",
    "faq.kicker": "FAQ",
    "faq.title": "Preguntas frecuentes",
    "faq.q1": "¿Cómo contratar a Myguel Santos e Castro?",
    "faq.a1": "Rellena el formulario de abajo con la fecha, el lugar, el público y el objetivo del evento. También puedes contactar por WhatsApp.",
    "faq.q2": "¿Qué servicios están disponibles?",
    "faq.a2": "Team building musical, conciertos, workshops, masterclasses, jurado y charlas motivacionales.",
    "faq.q3": "¿Actúa fuera de Portugal?",
    "faq.a3": "Sí. Myguel Santos e Castro actúa internacionalmente en festivales, conciertos y eventos.",
    "faq.q4": "¿Cuál es el plazo para recibir respuesta?",
    "faq.a4": "Normalmente en 24 a 48 horas hábiles con una propuesta ajustada al evento.",
    ...
    "testimonials.title": "Lo que dicen quienes han trabajado con Myguel",
    "testimonials.q1": '"Invité a Myguel para una sesión de apertura de un ciclo de conferencias. La energía que trajo a la sala en los primeros veinte minutos marcó el tono de todo el día. El feedback de los participantes fue unánime."',
    "testimonials.q2": '"Hice el taller de voz con Myguel en un evento con 60 personas. No creía que pudiera mantener a todos involucrados en una actividad así. Acabó siendo el momento más comentado del día."',
    "testimonials.q3": '"Participé en una masterclass de dirección coral y el nivel de atención individual fue sorprendente. Salí con herramientas concretas que aplico todavía hoy en mis propios ensayos."',
    "testimonials.role1": "organizador de eventos",
    "testimonials.role2": "participante",
    "testimonials.role3": "directora coral",
    ...
    "contact.pr": "Relaciones públicas",
    "social.kicker": "Redes Sociales",
    "social.title": "Sigue y acompaña el trabajo de Myguel",
    "form.name": "Nombre",
    ...
    "ai.title": "Sobre Myguel Santos e Castro",
    "ai.chip.services": "¿Qué servicios ofrece?",
    "ai.chip.hire": "¿Cómo contratar?",
    "ai.chip.international": "¿Experiencia internacional?",
    "ai.chip.voxlaci": "¿Qué es VoxLaci?",
    "ai.chip.bio": "¿Quién es Myguel?",
  ...
  zh: {
    ...
    "nav.about": "关于",
    "nav.contact": "联系",
    "hero.eyebrow": "丈夫 • 父亲 • 指挥 • 教授 • 教练 • 演讲者 • 评审 • 顾问",
    "hero.title": "米格尔·桑托斯·卡斯特罗 — 留存记忆的艺术体验。",
    "hero.copy": "葡萄牙指挥家，30年舞台经验。与葡萄牙及国际的企业、节日和机构合作，创造能够改变团队、观众和活动的时刻。",
    "hero.cta": "申请提案",
    "hero.whatsapp": "WhatsApp",
    "hero.secondary": "查看格式",
    "hero.whatsappMsg": "您好，我想为活动聘用米格尔·桑托斯·卡斯特罗。",
    "faq.kicker": "常见问题",
    "faq.title": "常见问题解答",
    "faq.q1": "如何聘请Myguel Santos e Castro？",
    "faq.a1": "请在下方填写表格，填写日期、场地、观众和活动目标。也可以通过WhatsApp联系。",
    "faq.q2": "有哪些服务可用？",
    "faq.a2": "音乐团队建设、音乐会、工作坊、大师班、评审和励志演讲。",
    "faq.q3": "他在葡萄牙以外演出吗？",
    "faq.a3": "是的。Myguel Santos e Castro在国际节日、音乐会和活动中演出。",
    "faq.q4": "收到回复需要多长时间？",
    "faq.a4": "通常在24至48个工作小时内收到针对活动量身定制的提案。",
    "strip.concerts": "音乐会",
    "strip.jury": "评审",
    ...
    "testimonials.kicker": "见证",
    "testimonials.title": "与Myguel合作过的人怎么说",
    "testimonials.q1": '"我邀请了Myguel为一个会议系列开幕。他在前二十分钟内给房间带来的能量定下了整天的基调。参与者的反馈是一致的。"',
    "testimonials.q2": '"我在一个60人的活动中与Myguel做了声音工作坊。我不相信他能让所有人都参与其中。结果它成为了当天讨论最多的时刻。"',
    "testimonials.q3": '"我参加了合唱指挥大师班，个人关注的程度令人惊讶。我带着至今仍在自己排练中使用的具体工具离开。"',
    "testimonials.role1": "活动组织者",
    "testimonials.role2": "参与者",
    "testimonials.role3": "合唱指挥",
    ...
    "form.submit": "发送请求",
    "footer.top": "返回顶部",
    "ai.title": "关于 Myguel Santos e Castro",
    "ai.chip.services": "提供什么服务？",
    "ai.chip.hire": "如何预约？",
    "ai.chip.international": "国际经验？",
    "ai.chip.voxlaci": "VoxLaci是什么？",
    "ai.chip.bio": "Myguel是谁？",
    "ai.placeholder": "写下你的问题…",
    "share.copy": "复制链接",
    "share.copied": "已复制！",
    mailSubject: "提案请求",
    mailName: "姓名",
  ...
  ar: {
    ...
    "nav.about": "حول",
    "nav.contact": "اتصل",
    "hero.eyebrow": "زوج • أب • قائد جوقة • أستاذ • مدرب • خطيب • محكّم • مستشار",
    ...
    "hero.whatsappMsg": "مرحباً، أرغب في التعاقد مع ميغيل سانتوس إي كاسترو لفعالية.",
    ...
    "testimonials.kicker": "شهادات",
    "testimonials.title": "ما يقوله من عمل مع ميغيل",
    "testimonials.q1": '"دعوت ميغيل لجلسة افتتاح دورة مؤتمرات. الطاقة التي أضافها إلى القاعة في الدقائق العشرين الأولى حددت نغمة اليوم بأكمله. كانت آراء المشاركين متفقة."',
    "testimonials.q2": '"أجريت ورشة عمل الصوت مع ميغيل في فعالية مع 60 شخصاً. لم أكن أصدق أنه سيتمكن من إبقاء الجميع منخرطين في نشاط كهذا. انتهى الأمر بأنه كان اللحظة الأكثر تداولاً في ذلك اليوم."',
    "testimonials.q3": '"شاركت في ماستركلاس لقيادة الكورال وكان مستوى الاهتمام الفردي مدهشاً. غادرت بأدوات ملموسة لا أزال أطبقها اليوم في تمارينني الخاصة."',
    "testimonials.role1": "منظم فعاليات",
    "testimonials.role2": "مشارك",
    "testimonials.role3": "مديرة كورال",
    ...
    "contact.pr": "العلاقات العامة",
    "social.kicker": "وسائل التواصل الاجتماعي",
    "social.title": "تابع وواكب عمل ميغيل",
    "form.name": "الاسم",
    ...
    "ai.title": "حول ميغيل سانتوس إي كاسترو",
    "ai.chip.services": "ما الخدمات المقدمة؟",
    "ai.chip.hire": "كيف يتم التعاقد؟",
    "ai.chip.international": "تجربة دولية؟",
    "ai.chip.voxlaci": "ما هي VoxLaci؟",
    "ai.chip.bio": "من هو ميغيل؟",
...
const applyLanguage = (language) => {
  ...
  if (waLink && dictionary["hero.whatsappMsg"]) {
    waLink.href = `https://wa.me/351925075186?text=${encodeURIComponent(dictionary["hero.whatsappMsg"])}`;
  }
};
  ...
  if (platform === "copy") {
    el.addEventListener("click", () => {
      navigator.clipboard.writeText(window.location.href).then(() => {
        ...
        label.textContent = dict["share.copied"] || "Copiado!";
        setTimeout(() => {
          label.textContent = dict["share.copy"] || "Copiar link";
        }, 2000);
      });
    });
...
(async function loadInstagramFeed() {
  ...
  if (!grid) return;
  try {
    const res = await fetch("/instagram-feed");
    if (!res.ok) return;
